          ...
          <div class="row">
            <div class="col-md-8 col-lg-6">
              ...
              <div class="hero-actions">
                ...
                <button class="btn-hero-secondary" onclick="toggleWatchlist(${m.id}, '${m.title.replace(/'/g, "\\'").replace(/"/g, "&quot;")}', '${m.poster}', ${m.year}, ${m.rating}, '${m.type}')" data-watchlist-id="${m.id}" id="heroWL${m.id}">
    ...
    <div class="scroll-card" onclick="goToDetail(${m.id}, '${m.type}')">
      <div style="position:relative;overflow:hidden;">
        ...
        <button class="scroll-card-watchlist ${isInWatchlist(m.id) ? 'in-watchlist' : ''}" data-watchlist-id="${m.id}"
          onclick="event.stopPropagation(); toggleWatchlist(${m.id}, '${m.title.replace(/'/g, "\\'").replace(/"/g, "&quot;")}', '${m.poster}', ${year}, ${m.rating}, '${m.type}')">
          <i class="bi ${isInWatchlist(m.id) ? 'bi-bookmark-fill' : 'bi-bookmark-plus'}"></i>
        </button>
