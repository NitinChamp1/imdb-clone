  ...
  document.getElementById('detailContent').innerHTML = `
    ...
    <div class="bg-dark-custom py-5">
      <div class="container-fluid px-4">
        <div class="row g-4">
          <!-- Main Content -->
          <div class="col-lg-8 hide-scrollbar" style="max-height: 100vh; overflow-y: auto; padding-right: 15px; scrollbar-width: none;">
            <!-- Cast -->
          ...
          <!-- Sidebar -->
          <div class="col-lg-4 hide-scrollbar" style="max-height: 100vh; overflow-y: auto; padding-right: 15px; scrollbar-width: none;">
            <div>
              <!-- Stats -->
              <div class="p-4 rounded-3 mb-4" style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.06);">
